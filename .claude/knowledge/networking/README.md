...
| `_archive/client-side-routing-hiddify-2026-05.md` | **Отменённое знание**, вынесенное из рабочего файла целиком 05.08.2026: правила маршрутизации на клиенте через Hiddify (модель отменена 22.05.2026) плюс явный список российских доменов. Синтаксис sing-box, а не Xray. Без frontmatter и TTL: слой вне модели ADR-0006, актуализации не подлежит. **Читать только за историей** — действующее в `_reference/routing-server-3xui.md` |
