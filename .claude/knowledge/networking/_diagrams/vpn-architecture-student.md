...
**Default в этом курсе** — только TUN. SOCKS5-режим не используем.
...
**Когда нужно:**
- У тебя несколько ученических аккаунтов AI и боишься что они «слипнутся» по shared IP
- AI начали тебя банить (но обычно причина не в IP)

**Когда НЕ нужно:**
- Стандартный сценарий — это избыточно
- Большинству учеников достаточно подписки провайдера
