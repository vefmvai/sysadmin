...
# Ровно этой формы тест не покрывал с 05.08 по 18.08.2026, и всё это время линтер
# объявлял её заголовки несуществующими: в шаблоне стояло «§?», а § в UTF-8 двухбайтовый,
# из-за чего первый байт становился обязательным. Замок молча блокировал живые маршруты.
